package com.ineffa.thewildupgrade.client.rendering;
...
public class TheWildUpgradeRenderTypes extends RenderLayer {

    public TheWildUpgradeRenderTypes(String name, VertexFormat vertexFormat, VertexFormat.DrawMode drawMode, int expectedBufferSize, boolean hasCrumbling, boolean translucent, Runnable startAction, Runnable endAction) {
