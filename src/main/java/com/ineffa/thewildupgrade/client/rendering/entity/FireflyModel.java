...
public class FireflyModel extends AnimatedGeoModel<FireflyEntity> {
    private static final Identifier TEXTURE = new Identifier(TheWildUpgrade.MOD_ID, "textures/entity/firefly/firefly.png");

    @Override
    public Identifier getModelResource(FireflyEntity entity) {
        return new Identifier(TheWildUpgrade.MOD_ID, "geo/firefly.geo.json");
    }

    @Override
    public Identifier getAnimationResource(FireflyEntity entity) {
        return new Identifier(TheWildUpgrade.MOD_ID, "animations/firefly.animation.json");
    }
