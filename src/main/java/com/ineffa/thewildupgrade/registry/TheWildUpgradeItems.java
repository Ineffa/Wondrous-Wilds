...
public class TheWildUpgradeItems {
    ...
    public static final BlockItem HOLLOW_MANGROVE_LOG = new BlockItem(TheWildUpgradeBlocks.HOLLOW_MANGROVE_LOG, new FabricItemSettings().group(ItemGroup.BUILDING_BLOCKS));
    public static final BlockItem HOLLOW_CRIMSON_STEM = new BlockItem(TheWildUpgradeBlocks.HOLLOW_CRIMSON_STEM, new FabricItemSettings().group(ItemGroup.BUILDING_BLOCKS));
    public static final BlockItem HOLLOW_WARPED_STEM = new BlockItem(TheWildUpgradeBlocks.HOLLOW_WARPED_STEM, new FabricItemSettings().group(ItemGroup.BUILDING_BLOCKS));
    public static final BlockItem HOLLOW_STRIPPED_OAK_LOG = new BlockItem(TheWildUpgradeBlocks.HOLLOW_STRIPPED_OAK_LOG, new FabricItemSettings().group(ItemGroup.BUILDING_BLOCKS));
    public static final BlockItem HOLLOW_STRIPPED_SPRUCE_LOG = new BlockItem(TheWildUpgradeBlocks.HOLLOW_STRIPPED_SPRUCE_LOG, new FabricItemSettings().group(ItemGroup.BUILDING_BLOCKS));
    public static final BlockItem HOLLOW_STRIPPED_BIRCH_LOG = new BlockItem(TheWildUpgradeBlocks.HOLLOW_STRIPPED_BIRCH_LOG, new FabricItemSettings().group(ItemGroup.BUILDING_BLOCKS));
    ...
    public static final BlockItem HOLLOW_STRIPPED_CRIMSON_STEM = new BlockItem(TheWildUpgradeBlocks.HOLLOW_STRIPPED_CRIMSON_STEM, new FabricItemSettings().group(ItemGroup.BUILDING_BLOCKS));
    public static final BlockItem HOLLOW_STRIPPED_WARPED_STEM = new BlockItem(TheWildUpgradeBlocks.HOLLOW_STRIPPED_WARPED_STEM, new FabricItemSettings().group(ItemGroup.BUILDING_BLOCKS));
    ...
    public static void initialize() {
        ...
        Registry.register(Registry.ITEM, new Identifier(TheWildUpgrade.MOD_ID, "hollow_mangrove_log"), HOLLOW_MANGROVE_LOG);
        Registry.register(Registry.ITEM, new Identifier(TheWildUpgrade.MOD_ID, "hollow_crimson_stem"), HOLLOW_CRIMSON_STEM);
        Registry.register(Registry.ITEM, new Identifier(TheWildUpgrade.MOD_ID, "hollow_warped_stem"), HOLLOW_WARPED_STEM);
        Registry.register(Registry.ITEM, new Identifier(TheWildUpgrade.MOD_ID, "hollow_stripped_oak_log"), HOLLOW_STRIPPED_OAK_LOG);
        Registry.register(Registry.ITEM, new Identifier(TheWildUpgrade.MOD_ID, "hollow_stripped_spruce_log"), HOLLOW_STRIPPED_SPRUCE_LOG);
        Registry.register(Registry.ITEM, new Identifier(TheWildUpgrade.MOD_ID, "hollow_stripped_birch_log"), HOLLOW_STRIPPED_BIRCH_LOG);
        ...
        Registry.register(Registry.ITEM, new Identifier(TheWildUpgrade.MOD_ID, "hollow_stripped_crimson_stem"), HOLLOW_STRIPPED_CRIMSON_STEM);
        Registry.register(Registry.ITEM, new Identifier(TheWildUpgrade.MOD_ID, "hollow_stripped_warped_stem"), HOLLOW_STRIPPED_WARPED_STEM);
    }
}
