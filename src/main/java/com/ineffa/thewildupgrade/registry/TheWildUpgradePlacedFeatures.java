...
public class TheWildUpgradePlacedFeatures {
    ...
    public static final RegistryEntry<PlacedFeature> TALL_BIRCH_CHECKED = register("tall_birch_checked", TheWildUpgradeConfiguredFeatures.TALL_BIRCH, PlacedFeatures.wouldSurvive(Blocks.BIRCH_SAPLING));

    public static final RegistryEntry<ConfiguredFeature<RandomFeatureConfig, ?>> BIRCH_FOREST_TREES = TheWildUpgradeConfiguredFeatures.register("birch_forest_trees", Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(TreePlacedFeatures.BIRCH_CHECKED, 0.15F), new RandomFeatureEntry(FANCY_BIRCH_WITH_BEES_CHECKED, 0.0125F)), FANCY_BIRCH_CHECKED));
    public static final RegistryEntry<ConfiguredFeature<RandomFeatureConfig, ?>> OLD_GROWTH_BIRCH_FOREST_TREES = TheWildUpgradeConfiguredFeatures.register("old_growth_birch_forest_trees", Feature.RANDOM_SELECTOR, new RandomFeatureConfig(List.of(new RandomFeatureEntry(TALL_BIRCH_CHECKED, 0.075F), new RandomFeatureEntry(TreePlacedFeatures.BIRCH_CHECKED, 0.025F), new RandomFeatureEntry(FANCY_BIRCH_WITH_BEES_CHECKED, 0.015F)), FANCY_BIRCH_CHECKED));
    ...
    public static final RegistryEntry<PlacedFeature> OLD_GROWTH_BIRCH_FOREST_TREES_PLACED = register("old_growth_birch_forest_trees", OLD_GROWTH_BIRCH_FOREST_TREES, VegetationPlacedFeatures.modifiersWithWouldSurvive(PlacedFeatures.createCountExtraModifier(5, 0.1f, 1), Blocks.BIRCH_SAPLING));
